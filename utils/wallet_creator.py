...
class WalletCreator:
    ...
    DEFAULT_WALLET_DIR = config.WALLET_DIR
    @staticmethod
    ...
    def generate_address(public_key: bytes) -> str:
        ...
        Returns:
            str: Base58 encoded wallet address with Q prefix
        """
        ...
        # Add version byte (0x01 for Qbitcoin addresses)
        versioned_hash = b'\x01' + hash160
        ...
        # Encode with Base58 and add Q prefix
        return "Q" + base58.b58encode(binary_address).decode('utf-8')
