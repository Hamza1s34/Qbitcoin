...
class TestMiningAPI(TestCase):
    ...
    def test_GetBlockMiningCompatible(self):
        ...
        req = qbitmining_pb2.GetBlockMiningCompatibleReq(height=10)
    ...
    def test_GetLastBlockHeader(self):
        ...
        req = qbitmining_pb2.GetLastBlockHeaderReq(height=20)
    ...
    def test_GetBlockToMine(self):
        ...
        req = qbitmining_pb2.GetBlockToMineReq(wallet_address=b'fake address')
    ...
    def test_SubmitMinedBlock(self):
        req = qbitmining_pb2.SubmitMinedBlockReq(blob=b'minedblob')
