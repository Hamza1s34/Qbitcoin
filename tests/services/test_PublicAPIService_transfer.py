    ...
    def test_messageTxn_sign(self):
        with set_qrl_dir('wallet_ver1'):
            with State() as db_state:
                ...
                request = qbit_pb2.MessageTxnReq(
                    message=my_message,
                    fee=12,
                    xmss_pk=alice.pk
                )
                ...
                req_push = qbit_pb2.PushTransactionReq(transaction_signed=signed_transaction)
                ...
                self.assertEqual(qbit_pb2.PushTransactionResp.SUBMITTED,
    ...
    def test_transferCoins_get_unsigned(self):
        with set_qrl_dir('wallet_ver1'):
            with State() as db_state:
                ...
                request = qbit_pb2.TransferCoinsReq(
    ...
    def test_transferCoins_push_unsigned(self):
        with set_qrl_dir('wallet_ver1'):
            with State() as db_state:
                ...
                req_push = qbit_pb2.PushTransactionReq(transaction_signed=response.extended_transaction_unsigned.tx)
                ...
                self.assertIsNotNone(resp_push)
                self.assertEqual(qbit_pb2.PushTransactionResp.VALIDATION_FAILED,
                                 resp_push.error_code)
