...
from qbitcoin.daemon.helper.DaemonHelper import WalletDecryptionError
...
class TestWalletD(TestCase):
    ...
    def test_get_unused_ots_index(self):
        with set_qrl_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetOTS = Mock(
                return_value=qbit_pb2.GetOTSResp(next_unused_ots_index=10, unused_ots_index_found=True))
            ...
            walletd._public_stub.GetOTS = Mock(
                return_value=qbit_pb2.GetOTSResp(next_unused_ots_index=10, unused_ots_index_found=False))
    ...
    def test_sign_and_push_transaction(self):
        with set_qrl_dir("wallet_ver1"):
            ...
            walletd._public_stub.PushTransaction = Mock(
                return_value=qbit_pb2.PushTransactionResp(error_code=qbit_pb2.PushTransactionResp.UNKNOWN))
    ...
    def test_get_transaction(self):
        with set_qrl_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetTransaction = Mock(
                return_value=qbit_pb2.GetTransactionResp(tx=tx,
                                                        confirmations=10,
                                                        block_number=5,
