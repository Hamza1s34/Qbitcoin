...
from qbitcoin.core.misc import logger, db
...
@mock.patch('qbitcoin.core.misc.ntp.getTime', new=replacement_getTime)
class TestState(TestCase):
    ...
    def test_get_block_size_limit(self):
        ...
        with patch('qbitcoin.core.Block.Block.get_block', return_value=None):
