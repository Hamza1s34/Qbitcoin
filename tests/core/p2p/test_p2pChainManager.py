...
from qbitcoin.generated import qbit_pb2, qbitlegacy_pb2

logger.initialize_default()


def make_message(**kwargs):
    return qbitlegacy_pb2.LegacyMessage(**kwargs)
...
class TestP2PChainManager(TestCase):
    ...
    def test_handle_fetch_block(self, m_logger):
        ...
        self.channel.factory.get_block_by_number.return_value = Mock(autospec=Block, pbdata=qbit_pb2.Block())
        msg = make_message(func_name=qbitlegacy_pb2.LegacyMessage.FB, fbData=qbitlegacy_pb2.FBData(index=1))
    ...
    def test_handle_fetch_block_bad_height(self, m_logger):
        ...
        """
        self.channel.factory.chain_height = 10
        msg = make_message(func_name=qbitlegacy_pb2.LegacyMessage.FB, fbData=qbitlegacy_pb2.FBData(index=100))
        self.manager.handle_fetch_block(self.channel, msg)
    ...
    def test_handle_push_block(self, m_logger):
        ...
        :return:
        """
        msg = make_message(func_name=qbitlegacy_pb2.LegacyMessage.PB, pbData=qbitlegacy_pb2.PBData(block=qbit_pb2.Block()))
    ...
    def test_handle_push_block_bad_block(self, m_Block, m_logger):
        ...
        msg = make_message(func_name=qbitlegacy_pb2.LegacyMessage.PB)
        self.manager.handle_push_block(self.channel, msg)
    ...
    def test_handle_block(self, m_logger):
        ...
        :return:
        """
        msg = make_message(func_name=qbitlegacy_pb2.LegacyMessage.BK,
                           block=qbit_pb2.Block(),
                           mrData=qbitlegacy_pb2.MRData()
                           )
    ...
    def test_handle_block_height_incoming_request(self, m_logger):
        ...
        incoming_request = make_message(func_name=qbitlegacy_pb2.LegacyMessage.BH,
    ...
    def test_handle_block_height_incoming_request_but_node_at_blockheight_zero(self, m_logger):
        ...
        incoming_request = make_message(func_name=qbitlegacy_pb2.LegacyMessage.BH,
                                        bhData=qbit_pb2.BlockHeightData(
                                            block_number=0,
                                        ))
        self.manager.handle_block_height(self.channel, incoming_request)
    ...
    def test_handle_block_height_incoming_information(self, m_logger):
        ...
        incoming_info = make_message(func_name=qbitlegacy_pb2.LegacyMessage.BH,
                                     bhData=qbit_pb2.BlockHeightData(
                                         block_number=1,
    ...
    def test_handle_node_headerhash_peer_has_no_headerhashes(self, m_logger):
        ...
        """
        self.channel.factory.get_headerhashes.return_value = qbit_pb2.NodeHeaderHash()
        incoming_request = make_message(func_name=qbitlegacy_pb2.LegacyMessage.HEADERHASHES,
                                        nodeHeaderHash=qbit_pb2.NodeHeaderHash(block_number=0)
                                        )
    ...
    def test_handle_node_headerhash_peer_has_headerhashes(self, m_logger):
        ...
        """
        incoming_info = make_message(func_name=qbitlegacy_pb2.LegacyMessage.HEADERHASHES,
                                     nodeHeaderHash=qbit_pb2.NodeHeaderHash(block_number=3,
