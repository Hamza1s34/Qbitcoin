...
def make_node_chain_state():
    node_chain_state = qbit_pb2.NodeChainState(block_number=0,
                                              header_hash=b'',
...
class TestP2PPeerManager(TestCase):
    ...
    def test_handle_version(self):
        ...
        message = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.VE,
    ...
    def test_handle_version_empty_version_message(self):
        ...
        message = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.VE,
                                              veData=qbitlegacy_pb2.VEData(version='',
                                                                          genesis_prev_hash=config.user.genesis_prev_headerhash,
                                                                          rate_limit=config.user.peer_rate_limit))
        self.peer_manager.handle_version(channel, message)
    ...
    def test_handle_peer_list_works(self, logger):
        ...
        """
        peer_list_message = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.PL,
                                                        plData=qbitlegacy_pb2.PLData(
    ...
    def test_handle_peer_list_empty_peer_list_message(self, logger):
        ...
        """
        peer_list_message = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.PL,
                                                        plData=qbitlegacy_pb2.PLData(peer_ips={}, public_port=9000))
        channel = make_channel()
    ...
    def test_handle_sync(self):
        ...
        """
        sync_message = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.SYNC,
                                                   syncData=qbitlegacy_pb2.SYNCData(state='Synced'))
        channel = make_channel()
    ...
    def test_handle_sync_unsynced(self):
        ...
        """
        sync_message = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.SYNC,
                                                   syncData=qbitlegacy_pb2.SYNCData(state='Unsynced'))
        channel = make_channel()
    ...
    def test_handle_sync_blank(self):
        ...
        """
        sync_message = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.SYNC,
                                                   syncData=qbitlegacy_pb2.SYNCData(state=''))
        channel = make_channel()
    ...
    def test_handle_chain_state_works(self):
        ...
        chain_state_message = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.CHAINSTATE,
    ...
    def test_handle_p2p_acknowledgement(self):
        ...
        """
        ack = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.P2P_ACK,
                                          p2pAckData=qbit_pb2.P2PAcknowledgement(bytes_processed=15))
        channel = make_channel()
    ...
    def test_handle_p2p_acknowledgement_negative_bytes_processed(self):
        ...
        """
        ack = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.P2P_ACK,
                                          p2pAckData=qbit_pb2.P2PAcknowledgement(bytes_processed=20))
        channel = make_channel()
