...
from qbitcoin.core.p2p import p2pPeerManager
from qbitcoin.core.p2p.p2pfactory import P2PFactory, p2p_msg_priority
...
class TestP2PProtocol(TestCase):
    ...
    def test_wrap_message_works(self):
        veData = qbitlegacy_pb2.VEData(version="version", genesis_prev_hash=b'genesis_hash')
        msg = qbitlegacy_pb2.LegacyMessage(func_name=qbitlegacy_pb2.LegacyMessage.VE, veData=veData)
